        ...
        if(err){
          ...
          if(collection){
            collection.isCapped(function(err, capped){
              ...
              if(capped){
                ensureIndexes(err, collection);
              }else{
                self.mongoConnection.dropCollection(self.options.collectionName, function(){
                    self.mongoConnection.createCollection(self.options.collectionName, {capped: true, size: self.options.collectionSize, autoIndexId: true}, ensureIndexes);
                  });
              }
            });
          }else{
